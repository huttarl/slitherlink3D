...
- genCapsid — a prolate viral capsid: the triangulated side of the fullerene
  construction, elongated, with a pentagonal DNA portal where one five-fold vertex was.
- genNanotube — an open (n,m) carbon nanotube, from a honeycomb sheet rolled into a
  cylinder: zigzag, armchair or chiral.
